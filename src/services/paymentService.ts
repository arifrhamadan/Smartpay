    ...
    if (!students || students.length === 0) {
      const demoStudents = [
        ...
        { 
          ...
          parentName: 'Santoso', 
          parentPhone: '08129876111'
        },
        { 
          name: 'Citra Lestari', 
          classId: 'B1', 
          className: 'B1 - Kindergarten', 
          nis: '2001', 
          gender: 'Perempuan',
          studentType: 'Reguler', 
          meetingPackage: '16x', 
        ...
        { 
          ...
          phone: '08125555666',
          address: 'Jl. Flamboyant No. 8',
          parentName: 'Kurniawan', 
          parentPhone: '08129876333'
        },
        { 
          name: 'Eka Putri', 
          classId: 'B2', 
          className: 'B2 - Kindergarten', 
          nis: '2003', 
          gender: 'Perempuan',
          studentType: 'Reguler', 
          meetingPackage: '16x', 
